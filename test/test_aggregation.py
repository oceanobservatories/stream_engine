...
class AggregationTest(unittest.TestCase):
    def setUp(self):
        ...
        self.jsondir = '/Users/petercable/20161018T182550-RS03CCAL-MJ03F-05-BOTPTA301-streamed-botpt_nano_sample'

    def tearDown(self):
        shutil.rmtree(self.tempdir)

    def test_aggregate_json(self):
        aggregate_provenance_json(self.jsondir, self.tempdir)
    ...
    def test_collect_subjob_info(self):
        from pprint import pprint
        pprint(collect_subjob_info(self.jsondir))

    def test_generate_ncml(self):
        generate_ncml(self.jsondir, self.jsondir)
        print os.listdir(self.tempdir)
        print open(os.path.join(self.tempdir, 'deployment0001_RS03CCAL-MJ03F-05-BOTPTA301-streamed-botpt_nano_sample.ncml')).read()