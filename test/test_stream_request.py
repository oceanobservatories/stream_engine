...
class StreamRequestTest(unittest.TestCase):
    ...
    #
    # @unittest.skip('this is just here to check if order of interpolation matters')
    ...
    #         'CC_a0': 0.001252507,
    #         'CC_a1': 0.000277772,
    #         'CC_a2': -0.000001743991,
    #         'CC_a3': 0.000000204535,
    #         'CC_cpcor': -0.0000000957,
    #         'CC_ctcor': 0.00000325,
    #         'CC_g': -0.9733758,
    #         'CC_h': 0.1472746,
    #         'CC_i': -0.0001213067,
    ...
    #     nutnr_fn = 'nutnr_a_sample.nc'
    #     ctdpf_fn = 'ctdpf_sbe43_sample.nc'
    #     ctdpf_ds = xray.open_dataset(os.path.join('data', ctdpf_fn), decode_times=False)
    #     times = ctdpf_ds.time.values
    #     new_times = np.linspace(times[0], times[-1], num=len(times) * 2)
    #
    #     tempwat = ctd_sbe16plus_tempwat(ctdpf_ds.temperature, cals['CC_a0'], cals['CC_a1'],
    #                                     cals['CC_a2'], cals['CC_a3'])
    #
    #     interp_ds = interp1d_Dataset(ctdpf_ds, time=new_times)
    #     interp_tempwat = _numeric_interpolation(times, tempwat, new_times)
    #     new_tempwat = ctd_sbe16plus_tempwat(interp_ds.temperature, cals['CC_a0'], cals['CC_a1'],
    #                                         cals['CC_a2'], cals['CC_a3'])
    #
    #     np.testing.assert_almost_equal(interp_tempwat, new_tempwat, decimal=7)
