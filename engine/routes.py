...
def csv():
    ...
    input_data = request.get_json()
    validate(input_data)
    return Response(delimited_data(input_data, delimiter=','), mimetype='text/csv')
...
def tab():
    ...
    input_data = request.get_json()
    validate(input_data)
    return Response(delimited_data(input_data, delimiter='\t'), mimetype='text/tab-separated-values')
