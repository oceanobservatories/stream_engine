...
class StreamRequest(object):
    ...
    def _create_derived_product(self, dataset, stream_key, param, deployment, source_dataset=None):
        ...
        kwargs, arg_metadata, messages = self._build_function_arguments(dataset, stream_key, function_map,
    ...
    def _locate_externals(self, parameters):
        ...
        def process_found_stream(stream_key, parameter):
            ...
            :return:
            """
            sk_needs_internal = stream_key.stream.needs_internal([p])
            sk_needs_external = stream_key.stream.needs_external([p])
