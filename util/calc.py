...
def _qc_check(stream_request, parameter, pd_data, primary_key):
    ...
    print pd_data.keys()
    print primary_key.stream.time_parameter
    print pd_data.get(primary_key.stream.time_parameter).get(primary_key.as_refdes())
