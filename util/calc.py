        ...
        if current_parameter_name is not None:
            ...
            if qc_parameter['valueType'].encode('ascii', 'ignore') == 'INT':
                try:
                    ...
                    log.error(
                        "For parameter '{}' in qc function '{}' being run against '{}', the value '{}' is not an integer number."
                            .format(current_parameter_name, current_qc_id, current_stream_parameter, qc_parameter_value))
                ...
                try:
                    ...
                    log.error(
                        "For parameter '{}' in qc function '{}' being run against '{}', the value '{}' is not a number."
                            .format(current_parameter_name, current_qc_id, current_stream_parameter, qc_parameter_value))
                    parameter_dict[current_parameter_name] = float('nan')
