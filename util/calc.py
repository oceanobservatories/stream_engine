...
=======
        args, arg_meta = build_func_map(param, coeffs, pd_data, stream_request, parameter_key)
>>>>>>> Issue #4500 added support for data product identifers as dpa args
...
=======
def build_func_map(parameter, coefficients, pd_data, stream_request, base_key):
>>>>>>> Issue #4500 added support for data product identifers as dpa args
    """
...
=======
            log.error("Encountered unknown preload function argument type: %s", val)
