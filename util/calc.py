...
class Chunk_Generator(object):
    ...
    #check qc parameters for this parameter
    #run qc function with given qc parameters
    #chunk[parameterid_qcfunction]={'data': qcResults, 'source':'qc'}
    def _qc_check(self, parameter, chunk):
        ...
        for function_name in qcs:
            ...
            chunk['%s_%s' %(parameter.name.encode('ascii', 'ignore'), function_name)] = {'data': getattr(module, function_name)(**qcs.get(function_name)), 'source': 'qc'}
